-- [[ COFFEE VIP HUB - PERFECT SLIDER 1-99999 BY SOUKSAKHONE ]] --
local LP = game:GetService("Players").LocalPlayer
local SG = Instance.new("ScreenGui", game:GetService("CoreGui"))
SG.Name = "CoffeeVIPHubPerfectSlider"
...
-- Custom Speed Input Box & Set Button
...
ApplySpeedBtn.Size = UDim2.new(0, 70, 0, 30)
...
SliderText.Text = "Speed Slider (1-99999): 16"
...
-- Menu Buttons
mkMenuBtn("🚀 Speed 500", 78, function()
    if LP.Character and LP.Character:FindFirstChild("Humanoid") then
        LP.Character.Humanoid.WalkSpeed = 500
    end
end)

mkMenuBtn("🔥 Speed 99999 (Ultra)", 118, function()
    if LP.Character and LP.Character:FindFirstChild("Humanoid") then
        LP.Character.Humanoid.WalkSpeed = 99999
    end
end)

mkMenuBtn("🔄 Reset Speed (16)", 158, function()
    if LP.Character and LP.Character:FindFirstChild("Humanoid") then
        LP.Character.Humanoid.WalkSpeed = 16
    end
end)

mkMenuBtn("❌ Close GUI", 198, function()
    SG:Destroy()
end)

-- Slider Drag Logic (1 to 99999)
...
UIS.InputChanged:Connect(function(input)
    if dragging and (input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch) then
        ...
        SliderText.Text = "Speed: " .. speedVal
