-- [[ COFFEE VIP HUB - ROUND ICON & ULTIMATE FLY BY SOUKSAKHONE ]] --
local LP = game:GetService("Players").LocalPlayer
local SG = Instance.new("ScreenGui", game:GetService("CoreGui"))
SG.Name = "CoffeeVIPHubRoundIcon"
...
-- Toggle Button (☕) placed inside MainMenu header
...
-- Standalone Round Coffee Icon Button (When minimized)
local RoundIconBtn = Instance.new("TextButton", SG)
...
RoundIconBtn.TextColor3 = Color3.fromRGB(255, 200, 0)
RoundIconBtn.TextSize = 24
RoundIconBtn.Font = Enum.Font.SourceSansBold
RoundIconBtn.Visible = false
RoundIconBtn.Active = true
RoundIconBtn.Draggable = true
Instance.new("UICorner", RoundIconBtn).CornerRadius = UDim.new(1, 0) -- Perfect Circle
...
-- 2. Fly Control Buttons (Fly, Land, Up, Down)
...
-- Fly Logic with Up/Down controls
local flying = false
local verticalDir = 0
...
FlyUpBtn.MouseButton2Down:Connect(function() verticalDir = 0 end)
...
-- Toggle Logic (Minimize to Round Icon / Maximize to Main Menu)
