-- [[ COFFEE VIP HUB - ULTIMATE FLY & COFFEE GUI BY SOUKSAKHONE ]] --
...
-- Coffee Toggle Button (☕) for Minimize / Maximize
local ToggleBtn = Instance.new("TextButton", MainFrame)
ToggleBtn.Size = UDim2.new(0, 35, 0, 25)
ToggleBtn.Position = UDim2.new(0, 195, 0, 5)
ToggleBtn.Text = "☕"
...
-- Coffee Toggle Logic (Minimize / Maximize)
local isOpen = true
