-- [[ COFFEE VIP HUB - SCROLLING MENU & RED BIG HITBOX ]] --
...
-- Main Menu Frame (ຂະໜາດຄົງທີ່ ແຕ່ມີໜ້າຕ່າງເລື່ອນຂ້າງໃນ)
...
-- 🌟 ScrollingFrame (ໜ້າຕ່າງເລື່ອນລົງໄດ້)
...
-- 🌟 Hitbox Extender Logic (ຂະຫຍາຍໃຫຍ່ຂຶ້ນ + ຂອບສີແດງ)
        ...
        if hitboxActive then
            for _, player in ipairs(game:GetService("Players"):GetPlayers()) do
                if player ~= LP and player.Character and player.Character:FindFirstChild("HumanoidRootPart") then
                    ...
                    hrp.Size = Vector3.new(20, 20, 20) -- ປັບຂະໜາດໃຫ້ໃຫຍ່ຂຶ້ນ
                    hrp.Transparency = 0.5
                    hrp.CanCollide = false
                    
                    -- ສ້າງຂອບສີແດງຫຸ້ມ (SelectionBox)
                    if not hrp:FindFirstChild("RedHitboxSelection") then
                        ...
                        selectionBox.Color3 = Color3.fromRGB(255, 0, 0) -- ສີແດງ
