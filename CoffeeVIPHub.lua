-- [[ COFFEE VIP HUB - GOD MODE, DAMAGE & FAST ATTACK ]] --
...
-- Main Menu Frame (ຂະຫຍາຍຂອບສູງຂຶ້ນເພື່ອຮອງຮັບປຸ່ມ Fast Attack)
local MainFrame = Instance.new("Frame", SG)
MainFrame.Size = UDim2.new(0, 240, 0, 488)
...
-- 7. NEW: Fast Attack Button (ຕີໄວ / ຕີຮົວ)
