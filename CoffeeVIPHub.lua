-- [[ COFFEE VIP HUB - BALANCED AIMBOT ]] --
...
-- 8. Balanced Aimbot / Lock Head Button
...
-- Balanced Aimbot / Lock Head Logic (จำกัดระยะ & นຸ່ມນວນຂຶ້ນ)
...
local MAX_DISTANCE = 85 -- កຳນົດໄລຍະສູງສຸດ (ປັບຫຼຸດລົງໄດ້ຖ້າຢາກໃຫ້ໃກ້ກວ່ານີ້)
    ...
    if aimbotActive and LP.Character and LP.Character:FindFirstChild("HumanoidRootPart") then
        pcall(function()
            ...
            if closestTarget then
                -- ໃຊ້ CFrame.Lerp ເພື່ອໃຫ້ກ້ອງຫັນໄປຫາເປົ້າໝາຍແບບນຸ່ມນວນ ບໍ່ກະຊາກແຮງ
